...
# Parsing + Configuration Script – EZEGEN1_TEST - Rev. A

This **Parsing + Configuration** script is designed for the **EZEGEN1_TEST** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – EZEGEN1_TEST Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **EZEGEN1_TEST** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
